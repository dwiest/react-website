...
import { networkParams } from "../../components/wallet/networks";
import { connectors } from "../../components/wallet/connectors";
import { toHex, truncateAddress } from "../../components/wallet/utils";
import { ethers } from "ethers";

const injected = new InjectedConnector({ supportedChainIds: [1, 3, 4, 6, 42] })
    ...
    <>
      <VStack justifyContent="center" alignItems="center" h="100vh">
        ...
        <VStack justifyContent="center" alignItems="center" padding="10px 0">
          ...
          <Text>{`Network ID: ${chainId ? chainId : "None Network"}`}</Text>
        </VStack>
        {active && (
